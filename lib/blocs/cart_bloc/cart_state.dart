...
class PlaceOrderCompletedState extends CartState {

  PlaceOrderCompletedState();
  @override
  String toString() => 'GetCartValuesCompletedState';
}

class PlaceOrderFailedState extends CartState {
  @override
  String toString() => 'PlaceOrderFailedState';
}

class PlaceOrderInProgressState extends CartState {
  @override
